...
This is a Python implementation of the minimum-work mountain building model proposed by [Masek and Duncan (1998)](/assets/pdf/minmountain.pdf). The fundamental hypothesis is that crustal deformation minimizes the total mechanical work, $W_{total}$, defined as the sum of dissipative frictional work ($W_f$) and gravitational potential work ($W_g$).
